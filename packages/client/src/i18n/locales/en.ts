export default {
  ...
  settings: {
    ...
    connection: {
      ...
      serverUrlHint: 'API address of the remote server',
      serverUrlPlaceholder: 'e.g., http://localhost:8000',
      apiKey: 'API Key',
      apiKeyHint: 'Access key for the remote server (optional)',
      apiKeyPlaceholder: 'sk-...',
      hide: 'Hide',
      show: 'Show',
      localHint: 'Connected to local Hermes CLI',
      cliUnavailableTitle: 'Hermes CLI Unavailable',
      cliUnavailableMessage: 'Local mode requires Hermes CLI to be installed. Please install Hermes Agent first.',
      localModeCliMissing: 'Local mode requires Hermes CLI, which is not currently available',
