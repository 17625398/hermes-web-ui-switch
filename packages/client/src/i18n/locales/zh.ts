export default {
  ...
  settings: {
    ...
    connection: {
      ...
      remoteMode: '分离部署模式',
      serverUrl: '服务器地址',
      serverUrlHint: '远程服务器的 API 地址',
      serverUrlPlaceholder: '例如 http://localhost:8000',
      apiKey: 'API Key',
      apiKeyHint: '远程服务器的访问密钥（可选）',
      apiKeyPlaceholder: 'sk-...',
      hide: '隐藏',
      show: '显示',
      localHint: '已连接到本地 Hermes CLI',
      cliUnavailableTitle: 'Hermes CLI 不可用',
      cliUnavailableMessage: '本地模式需要安装 Hermes CLI。请先安装 Hermes Agent 并启动。',
      localModeCliMissing: '本地模式需要 Hermes CLI，但当前不可用',
